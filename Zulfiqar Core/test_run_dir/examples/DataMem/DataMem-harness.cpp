...
class DataMem_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_storedata)));
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_addrr)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_store)));
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_load)));
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/examples/DataMem/DataMem.vcd";
